      ...
      <div className="z-10 w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center my-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-[#9A7D3C]/10 border border-[#9A7D3C]/30 text-[#9A7D3C] text-[9px] font-mono font-black uppercase tracking-widest">
